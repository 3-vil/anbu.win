...
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(81,40,136)
...
Logo.Image = "rbxassetid://123141132491733"
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/3-vil/anbu.win/refs/heads/main/infiniteyield.lua'))()")
	end
end)
